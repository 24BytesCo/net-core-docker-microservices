...
using (var scope = app.Services.CreateScope()) 
{
    ...
    // orderContext representa la conexión a la base de datos y contiene las configuraciones de Entity Framework Core.
    // GetRequiredService lanza una excepción si el servicio no está registrado.
    // Obtiene una instancia del contexto de la base de datos orderContext.
